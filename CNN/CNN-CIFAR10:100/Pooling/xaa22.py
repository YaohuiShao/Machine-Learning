...
with tf.name_scope('conv-layer-2'):
    ...
    conv2 = conv_layer(pool1,W_conv2,[1,1,1,1],64,dropout=False,keep_prob=keep_prob_conv)#16*16*64
    ...
    pool2 = tf.nn.avg_pool(activ2,ksize=[1, 2, 2, 1],strides=[1, 2, 2, 1],padding='SAME', name='pool2')
...
with tf.name_scope('train'):
    train_step = tf.train.AdamOptimizer(learning_rate=1e-5).minimize(error)
